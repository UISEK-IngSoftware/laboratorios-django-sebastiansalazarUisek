...
class Trainer(models.Model):  #Definir el modelo de datos para un entrenador en la base de datos
    ...
    picture = models.ImageField(upload_to="trainer_images", null=True, blank=True) #Definir un campo de imagen para almacenar la foto del entrenador, especificando la carpeta donde se guardarán las imágenes
